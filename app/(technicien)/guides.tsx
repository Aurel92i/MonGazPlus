...
const GUIDES_PRO: Guide[] = [
  {
    ...
    content: [
      ...
      '• Robinets du COMPTEUR : OUVERTS (obligatoire pour détecter une fuite)',
      '• Robinets des APPAREILS (gazinière, chaudière, chauffe-eau) : FERMÉS',
      '• BRÛLEURS et veilleuses : ÉTEINTS',
      '• Vérifier qu\'aucun appareil gaz n\'est en fonctionnement',
      '',
      '⚠️ RAPPEL CRITIQUE',
      '• Le compteur DOIT être ouvert sinon le gaz ne peut pas circuler',
      '• Si le compteur est fermé, aucune fuite ne sera détectable !',
      '',
      '📸 PHOTO AVANT',
      ...
      '',
      '📊 ANALYSE',
      '• L\'application compare les index via OCR',
  ...
  },
  {
    ...
    content: [
      ...
      '• Le robinet du compteur est déjà OUVERT (ne pas toucher)',
      '• Ouvrir les robinets des appareils',
      '• Rallumer les brûleurs/veilleuses',
      '',
      '3️⃣ CONTRÔLE FINAL',
